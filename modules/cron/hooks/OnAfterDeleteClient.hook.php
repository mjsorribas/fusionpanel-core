...
function WriteCronFile() {
    ...
    if ($numrows->fetchColumn() <> 0) {
        ...
        $line .= "#################################################################################" . fs_filehandler::NewLine();
        $line .= "# WE DO NOT RECOMMEND YOU MODIFY THIS FILE DIRECTLY, PLEASE USE FUSIONPANEL INSTEAD! " . fs_filehandler::NewLine();
        $line .= "#################################################################################" . fs_filehandler::NewLine();
        ...
        $line .= "# DO NOT MANUALLY REMOVE ANY OF THE CRON ENTRIES FROM THIS FILE, USE FUSIONPANEL     " . fs_filehandler::NewLine();
        $line .= "# INSTEAD! THE ABOVE ENTRIES ARE USED FOR FUSIONPANEL TASKS, DO NOT REMOVE THEM!     " . fs_filehandler::NewLine();
        $line .= "#################################################################################" . fs_filehandler::NewLine();
