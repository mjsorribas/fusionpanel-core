...
class module_controller extends ctrl_module
{
    ...
    static function getCreateCron()
    {
        ...
        $line .= '<td><input name="inScript" type="text" id="inScript" size="50" /><br />'
                ...
                . ui_language::translate('Note 1 : Script path is relative to your fusionpanel-user root directory:') . '<br>'
    ...
    static function WriteCronFile()
    {
        ...
        $line .= "#################################################################################" . fs_filehandler::NewLine();
        $line .= "# CRONTAB FOR FUSIONPANEL CRON MANAGER MODULE                                        " . fs_filehandler::NewLine();
        $line .= "# Module Developed by Bobby Allen, 17/12/2009                                    " . fs_filehandler::NewLine();
        $line .= "# File automatically generated by Fusionpanel " . sys_versions::ShowFusionpanelVersion() . fs_filehandler::NewLine();
        if (sys_versions::ShowOSPlatformVersion() == "Windows") {
        ...
        $line .= "#  -> USE FUSIONPANEL INSTEAD! (Menu -> Advanced -> Cron Manager)                    " . fs_filehandler::NewLine();
        $line .= "#################################################################################" . fs_filehandler::NewLine();
