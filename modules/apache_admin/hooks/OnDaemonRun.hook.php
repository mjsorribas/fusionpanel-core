...
function WriteVhostConfigFile()
{
    ...
    //Get email for server admin of Fusionpanel
    ...
    $serveremail = ( $getserveremail[ 'ac_email_vc' ] != "" )
                   ...
                   : "postmaster@" . ctrl_options::GetSystemOption( 'fusionpanel_domain' );

    $VHostDefaultPort = ctrl_options::GetSystemOption( 'apache_port' );
    $customPorts = array(ctrl_options::GetSystemOption( 'fusionpanel_port' ));
...
/*
    ...
    $line .= "# Automatically generated by Fusionpanel " . sys_versions::ShowFusionpanelVersion() . fs_filehandler::NewLine();
    $line .= "# Generated on: " . date( ctrl_options::GetSystemOption( 'fusionpanel_df' ), time() ) . fs_filehandler::NewLine();
    $line .= "#==== YOU MUST NOT EDIT THIS FILE : IT WILL BE OVERWRITTEN ====" . fs_filehandler::NewLine();
    $line .= "# Use Fusionpanel Menu -> Admin -> Module Admin -> Apache config" . fs_filehandler::NewLine();
    $line .= "################################################################" . fs_filehandler::NewLine();
    $line .= fs_filehandler::NewLine();
    ...
    $line .= fs_filehandler::NewLine();
    $line .= "# Configuration for Fusionpanel control panel." . fs_filehandler::NewLine();
    $line .= "<VirtualHost *:" . ctrl_options::GetSystemOption( 'fusionpanel_port' ) . ">" . fs_filehandler::NewLine();
    $line .= "ServerAdmin " . $serveremail . fs_filehandler::NewLine();
    $line .= 'DocumentRoot "' . ctrl_options::GetSystemOption( 'fusionpanel_root' ) . '"' . fs_filehandler::NewLine();
    $line .= "ServerName " . ctrl_options::GetSystemOption( 'fusionpanel_domain' ) . fs_filehandler::NewLine();
    $line .= 'ErrorLog "' . ctrl_options::GetSystemOption( 'log_dir' ) . 'fusionpanel-error.log" ' . fs_filehandler::NewLine();
    $line .= 'CustomLog "' . ctrl_options::GetSystemOption( 'log_dir' ) . 'fusionpanel-access.log" ' . ctrl_options::GetSystemOption( 'access_log_format' ) . fs_filehandler::NewLine();
    $line .= 'CustomLog "' . ctrl_options::GetSystemOption( 'log_dir' ) . 'fusionpanel-bandwidth.log" ' . ctrl_options::GetSystemOption( 'bandwidth_log_format' ) . fs_filehandler::NewLine();
    $line .= "AddType application/x-httpd-php .php" . fs_filehandler::NewLine();
    $line .= '<Directory "' . ctrl_options::GetSystemOption( 'fusionpanel_root' ) . '">' . fs_filehandler::NewLine();
    ...
    // Global custom Fusionpanel entry
    ...
    $line .= fs_filehandler::NewLine();
    $line .= "################################################################" . fs_filehandler::NewLine();
    $line .= "# Fusionpanel generated VHOST configurations below....." . fs_filehandler::NewLine();
    $line .= "################################################################" . fs_filehandler::NewLine();
    $line .= fs_filehandler::NewLine();
    ...
    // Fusionpanel virtual host container configuration
    ...
    while ( $rowvhost = $sql->fetch() ) {
        ...
        if ( $rowvhost[ 'vh_enabled_in' ] == 1 && ctrl_users::CheckUserEnabled( $rowvhost[ 'vh_acc_fk' ] ) ||
            ...
            elseif ( $rowvhost[ 'vh_type_in' ] == 3 ) {
                 ...
                 */
                // Bandwidth Settings
                //$line .= "Include C:/Fusionpanel/bin/apache/conf/mod_bw/mod_bw/mod_bw_Administration.conf" . fs_filehandler::NewLine();
