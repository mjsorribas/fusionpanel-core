...
class module_controller extends ctrl_module
{
    ...
    static function DisplayDNSUsagepChart()
    {
        ...
        $line .= "<img src=\"etc/lib/pChart2/fusionpanel/z3DPie.php?score=" . $active . "::" . $deleted . "&labels=Active Domain Records:   " . $active . "::Deleted Domain Records: " . $deleted . "&legendfont=verdana&legendfontsize=8&imagesize=240::190&chartsize=120::90&radius=100&legendsize=10::160\"/>";
        return $line;
    }
