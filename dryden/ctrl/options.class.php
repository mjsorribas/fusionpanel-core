 ...
 *
 * Options class communicates with the Fusionpanel database and can read and write system options.
 * @package zpanelx
...
class ctrl_options {
     ...
     * @param string $name The name of the system option (eg. fusionpanel_root)
    ...
    /**
     * An alias of 'GetSystemOption' to 'fix' the recent refactor of the fusionpanel code, this was affecting third-party modules which relied on this old function name.
     * @author Bobby Allen <ballen@bobbyallen.me>
